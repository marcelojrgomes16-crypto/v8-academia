...
export async function GET(request: NextRequest) {
  try {
    ...
    const gifBase = 'https://cdn.jsdelivr.net/gh/JahelCuadrado/ExerciseGymGifsDB@main'
    const exData = [
      { nome: 'Supino Reto', grupoMuscular: 'Peito', equipamento: 'Barra', imagemUrl: `${gifBase}/pectorals/barbell-bench-press.gif`, videoUrl: '' },
      { nome: 'Agachamento', grupoMuscular: 'Pernas', equipamento: 'Barra', imagemUrl: `${gifBase}/quads/barbell-squat.gif`, videoUrl: '' },
      { nome: 'Puxada Frontal', grupoMuscular: 'Costas', equipamento: 'Polia', imagemUrl: `${gifBase}/lats/cable-pulldown.gif`, videoUrl: '' },
      { nome: 'Desenvolvimento', grupoMuscular: 'Ombros', equipamento: 'Halteres', imagemUrl: `${gifBase}/delts/barbell-seated-overhead-press.gif`, videoUrl: '' },
      { nome: 'Rosca Direta', grupoMuscular: 'Biceps', equipamento: 'Barra', imagemUrl: `${gifBase}/biceps/barbell-curl.gif`, videoUrl: '' },
      { nome: 'Triceps Pulley', grupoMuscular: 'Triceps', equipamento: 'Polia', imagemUrl: `${gifBase}/triceps/cable-pushdown.gif`, videoUrl: '' },
      { nome: 'Leg Press', grupoMuscular: 'Pernas', equipamento: 'Maquina', imagemUrl: `${gifBase}/quads/lever-alternate-leg-press.gif`, videoUrl: '' },
      { nome: 'Abdominal Crunch', grupoMuscular: 'Abdomen', equipamento: 'Nenhum', imagemUrl: `${gifBase}/abs/assisted-sit-up.gif`, videoUrl: '' },
      { nome: 'Elevacao Lateral', grupoMuscular: 'Ombros', equipamento: 'Halteres', imagemUrl: `${gifBase}/delts/lateral-raise.gif`, videoUrl: '' },
      { nome: 'Remada Curvada', grupoMuscular: 'Costas', equipamento: 'Barra', imagemUrl: `${gifBase}/upper-back/barbell-bent-over-row.gif`, videoUrl: '' },
    ]

    for (const ex of exData) {
      const existing = await prisma.exercicio.findFirst({ where: { nome: ex.nome } })
      if (existing) {
        await prisma.exercicio.update({ where: { id: existing.id }, data: { imagemUrl: ex.imagemUrl, videoUrl: ex.videoUrl } })
      } else {
        await prisma.exercicio.create({ data: ex })
      }
    }
    logs.push('Exercicios criados/atualizados')
